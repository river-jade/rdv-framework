...
#  2014.01.07 - BTL
#    - Pulled distance functions and transforms out into a separate file that
#      is now sourced.
#    - Wrapped most of remaining code in a function that has its controlling
#      parameters passed in through the argument list.
#      Still building those arguments in this file and calling the function
#      in this file, but will change that later.
#      This should make it easier to test and reuse this code.
#      It was originally developed as a standalone hack to see if it could
#      work and then wrapped up in a PypeR call from the guppy python code.
...
genSppDistributionsFromExistingClusters =
    function (
                sppGenOutputDir,
                ...
                smoothSuitabilitiesWithGaussian,
                gaussianSuitabilitySmoothingMean,
                gaussianSuitabilitySmoothingSD,
...
}  #  end function - genSppDistributionsFromExistingClusters()
