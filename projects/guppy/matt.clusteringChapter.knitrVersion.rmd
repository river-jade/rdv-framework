...
- Would be good to have some diagnostic images right at the start of all this to help explore the data.  For example:
...
**ML book question: If you do pca, do you need to scale or does pca relieve the need for that?**
```{r eval=TRUE}
OPT.scale <- FALSE
OPT.PCA <- TRUE  
