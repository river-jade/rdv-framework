...
#' Write given matrix to a pgm file.
#'
#' @param table.to.write A matrix
#' @param filename.root A filename
#' @param num.table.rows An integer
#' @param num.table.cols An integer
#' @return nothing
#' @examples
#' write.pgm.file (table.to.write, filename.root, num.table.rows, num.table.cols)
...
#' Write given matrix to a text file without any header information.
#'
#' @param table.to.write A matrix
#' @param filename.root A filename
#' @param num.table.rows An integer
...
#' @return nothing
#' @examples
#' write.txt.file (table.to.write, filename.root, num.table.rows, num.table.cols, DEBUG)

write.txt.file <- function (table.to.write, filename.root,
                            num.table.rows, num.table.cols,
                            DEBUG=FALSE)    #  BTL - 2014.09.17 - Added.
  {
    #########################
...
#' Write given matrix to file in esri asc format.
#'
#' @param table.to.write A matrix
#' @param filename.root A filename
#' @param num.table.rows An integer
#' @param num.table.cols An integer
#' @param xllcorner An integer
#' @param yllcorner An integer
#' @param no.data.value An integer
#' @param cellsize An integer
#' @param DEBUG An integer/boolean
#' @return nothing
#' @examples
#' write.asc.file (table.to.write, filename.root, num.table.rows, num.table.cols, xllcorner, yllcorner, no.data.value, cellsize, DEBUG)
...
write.asc.file <- function (table.to.write, filename.root,
                            ...
                            DEBUG = FALSE           #  BTL - 2014.09.16 - Added.
                            )
  {
...
#' Write given matrix to file in esri asc format using string header values.
#'
#' @param table.to.write A matrix
#' @param filename.root A filename
#' @param ascFileHeaderAsStrVals A list
#' @return nothing
#' @examples
#' write.asc.file.usingStrHeaderVals (table.to.write, filename.root, ascFileHeaderAsStrVals)
...
#' Write pgm file and text file for given matrix.
#'
#' @param table.to.write A matrix
#' @param filename.root A filename
#' @param num.table.rows An integer
...
#' @return TRUE
#' @examples
#' write.pgm.txt.files (table.to.write, filename.root, num.table.rows, num.table.cols, DEBUG=FALSE)
...
#' Write esri asc format file and text file for given matrix.
#'
#' @param table.to.write A matrix
#' @param filename.root A filename
#' @param num.table.rows An integer
...
#' @return TRUE
#' @examples
#' write.asc.txt.files (table.to.write, filename.root, num.table.rows, num.table.cols, DEBUG=FALSE)

write.asc.txt.files <- function (table.to.write, filename.root,
                            num.table.rows, num.table.cols, DEBUG=FALSE)
  {
...
#' Write pgm file, esri asc format file, and text file for given matrix.
#'
#' @param table.to.write A matrix
#' @param filename.root A filename
#' @param num.table.rows An integer
...
#' @return TRUE
#' @examples
#' write.to.3.forms.of.files (table.to.write, filename.root,
#'                            num.table.rows, num.table.cols,
#'                            DEBUG=FALSE)
...
#' Write given vector to a given file.
#'
#' @param outfilename A filename
#' @param vecname A vector
#' @examples
#' writeOutputVector (outfilename, vecname)
