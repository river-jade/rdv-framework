...
if (runZonation)
    {
            #  Need to change this to match anything that starts with "darwin".
            #  For example, my current mac returns the OS as "darwin10.8.0".
